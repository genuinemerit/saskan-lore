...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_claim_entities_claim_id"), "claim_entities", ["claim_id"], unique=False
    )
    op.create_index(
        op.f("ix_claim_entities_entity_id"), "claim_entities", ["entity_id"], unique=False
    )
    op.create_table(
        "claims",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_eval_results_question_id"), "eval_results", ["question_id"], unique=False
    )
    op.create_table(
        "relationships",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
